...
def thread_proc(q,thread_number,transcript_list):
    ...
    for transcript in transcript_list:
        ...
        slope_5_dict[gene_name] = mean_slope(smoothed_data[:int(0.5*len(smoothed_data))])
        slope_3_dict[gene_name] = mean_slope(smoothed_data[int(0.5*len(smoothed_data)):])
