...
def thread_proc(q,thread_number,transcript_list):
    ...
    for transcript in transcript_list:
        ...
        if chrom+"_"+str(pos) in tes_visited:
            continue
        if chrom.find("_") != -1:
            continue

        tes_visited.append(chrom+"_"+str(pos))
...
parser.add_argument('-s','--start', dest='start',
                   help='Start analyzing coverage at this point before TES [default:1000]',default=1000,type=int)
parser.add_argument('-e','--end', dest='end',
                   help='Stop analyzing coverage at this point after TES [default:1000]',default=1000,type=int)
